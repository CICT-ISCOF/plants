...
> {
    ...
    componentDidMount() {
        ...
        if (fragments.includes('edit')) {
            ...
            new Model<Disease>(undefined, 'diseases')
                .find(id)
                .then((document) => {
                    this.fileRefs = document.images.map((_url, index) => {
    ...
    addImage() {
        ...
        const images = this.state.images;
        images.splice(index, 1, 'https://via.placeholder.com/200');
        this.setState({ images });
    }
                ...
                <form
                    ...
                    <div className='form-group'>
                        ...
                        <textarea
                            ...
                            disabled={this.state.processing}></textarea>
                    </div>
                    <div className='form-group'>
                                ...
                                {this.state.images.map((url, index) => (
                                    <div className='col-12 col-md-4 col-lg-3'>
                                        ...
                                        <img
                                            ...
                                            alt=''
                                            className='img-fluid clickable m-1'
                                            onClick={(e) => {
                                                e.preventDefault();
                                                this.fileRefs[
                                                    index
