    ...
    render() {
        return (
            ...
            <View  style={globalStyles.header}>
                    ...
                    <Text style={globalStyles.headerText}>Guide for {this.props.plant.name} </Text>
            </View>
            ...
            <ScrollView>
                {
                    this.props.plant.preparations.map((preparation, index) => {
                        return(
                                <View key={index}>
                                    <Text style={styles.title}>{preparation.title}</Text>
                                    <View style={styles.container}>
                                        <Text style={styles.textInContainer}>{preparation.type}</Text>
                                    </View>     
                                    {
                                        preparation.steps.map((guideItem, guideIndex) => {
                                            return (
                                                    <View key={guideIndex} style={styles.nextContainer}>
                                                        <Text style={styles.nextContainerTitle}>{guideItem}</Text>
                                                        <View style={styles.container}>
            ...
            <View  style={globalStyles.footer}>
                ...
                <View  style={[globalStyles.footerButtons,globalStyles.active]}>                   
                        <Ionicons name="ios-list-box" size={26}color={theme[themeState].footerActiveColor}  />
                        <Text style={[globalStyles.footerButtonTexts,{color:theme[themeState].footerActiveColor}]}> Guide </Text>
                </View>
